...
const HabitModal: React.FC<Props> = ({ visible, initialData, onClose, onSave, onDelete, habitId }) => {
  ...
  return (
    <Modal onRequestClose={() => {onClose(); setGeneratedTasks([])}} visible={visible} transparent animationType="slide">
      <TouchableOpacity activeOpacity={1} style={styles.overlay} onPressOut={() => {onClose(); setGeneratedTasks([])}}>
        <View
        >
          <TouchableWithoutFeedback>
            ...
            <View style={styles.modal}>
              ...
              <View style={styles.titleRow}>
                <TextInput placeholder="Add Habit" placeholderTextColor="gray" style={styles.title} value={formData.habitTitle} onChangeText={text => setFormData({ ...formData, habitTitle: text })} />
                {isEdit ? (
...
const styles = StyleSheet.create({
  ...
  modal: { backgroundColor: '#dab7ff', padding: 24, borderTopLeftRadius: 24, borderTopRightRadius: 24, position: 'relative' },
